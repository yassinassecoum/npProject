...
import './Dormir.css'
export class Dormir extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <NavBar />
                <div id="homeDormir">
                    <h1>Decouvre les meilleurs hotels sur Bruxelles </h1>
                    {(this.state.status ? <div className="addPlace">
                    <h3>Ajouter un hotel a découvrir a bruxelles</h3>
                    <form id="formDormir">
                            <label>Titre :</label>
                    ...
                    </div> : <p>Connectez vous pour ajouter des hotels.</p>)}
                    
                    <div className="dormirContainer">
                    {this.state.contenu}
                    </div>
                </div>
                <Footer />
