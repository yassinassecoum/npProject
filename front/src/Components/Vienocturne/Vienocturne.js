...
import './Vienocturne.css'
export class Vienocturne extends Component {
    ...
    async deletePost(e,id){
        ...
        fetch('http://localhost:4000/api/posts/delete',
            ...
            .then((res)=>{
                window.location.href = "http://localhost:3000/vienocturne";
            })
    ...
    componentDidMount(){
        ...
        .then((data)=>{
            ...
            const listObj=[]
            data.forEach((elem)=>{
                if(elem.category=="Boite" || elem.category=="Bars"){
        ...
        return (
            <div>
                ...
                <div id="homeVienocturne">
                    ...
                    </div> : <p>Connectez vous pour partager des endroits la nuit.</p>)}
                    
                    <div className="VienocturneContainer">
                    {this.state.contenu}
                    </div>
                </div>
                <Footer />
